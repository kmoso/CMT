...
if($params->get('display') && !($app->input->getCmd('option') == 'com_cobalt' && $app->input->getInt('section_id') == $section_id))
{
	return;
}

if($app->input->getCmd('option') == 'com_cobalt' && $app->input->getInt('section_id') == $section_id)
{
...
require JModuleHelper::getLayoutPath('mod_cobalt_submitbutton', $params->get('layout', 'default'));
