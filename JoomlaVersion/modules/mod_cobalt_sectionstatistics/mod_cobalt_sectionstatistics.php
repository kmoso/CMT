...
$data = modCobaltSectionStatisticsHelper::getData($params, $section_id);
if(!count($data)) return;

require JModuleHelper::getLayoutPath('mod_cobalt_sectionstatistics', $params->get('layout', 'default'));
