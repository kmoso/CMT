...
$doc->addStyleSheet(JURI::root() . 'modules/mod_cobalt_notifications/Scrollable/Scrollable.css');
$doc->addScript(JURI::root() . 'modules/mod_cobalt_notifications/Scrollable/Scrollable.js');
...
<div class="js_cc<?php echo $params->get('moduleclass_sfx') ?>">
	...
	<div class="mod_ntfcs">
		<a href="<?php echo JRoute::_('index.php?option=com_cobalt&view=notifications'.($sections ? '&section_id='.$sections : ''), false);?>">
	...
	function modMarkRead(id)
	{
		var req = new Request.JSON({
			url: "<?php echo JRoute::_('index.php?option=com_cobalt&task=ajax.mark_notification')?>",
			method:"post",
			autoCancel:true,
			data:{id: id},
	...
	{
		 var req = new Request.JSON({
			url: "<?php echo JRoute::_('index.php?option=com_cobalt&task=ajax.get_notifications')?>",
			method:"post",
			autoCancel:true,
