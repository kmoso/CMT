 ...
 */
class PlgButtonDummyContent extends JPlugin
{
	private $_alias = 'dummycontent';
	...
	private function getHelper()
	{
		...
		// allow in component?
		if (RLProtect::isRestrictedComponent(isset($params->components) ? $this->components : array()))
		{
			return false;
		}
