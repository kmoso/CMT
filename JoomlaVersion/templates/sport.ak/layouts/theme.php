    ...
    <div class="over-wrap">
		...
		<?php if ($this['widgets']->count('menu + search + logo')) : ?>
                    <div class="tm-menu-box"  >
                            ...
                            <nav class="tm-navbar uk-navbar" <?php if ($this['config']->get('sticky_menu')=="1"){ echo "data-uk-sticky=''";} ?>>
                                <div class="uk-container uk-container-center">
		...
		<?php if ($this['widgets']->count('top-a')) : ?>
                    <div class="tm-top-a-box <?php echo $box_classes['top-a']; ?>">
                        <div class="uk-container uk-container-center">
		...
		<?php if ($this['widgets']->count('top-b')) : ?>
                <div class="tm-top-b-box <?php echo $box_classes['top-b']; ?>">
                    <div class="uk-container uk-container-center">
                ...
                <div class="tm-top-c-box <?php echo $box_classes['top-c']; ?>">
                    <div class="uk-container uk-container-center">
                ...
                <div class="tm-top-d-box <?php echo $box_classes['top-d']; ?>">
                    <div class="uk-container uk-container-center">
                ...
                <div class="tm-top-e-box <?php echo $box_classes['top-e']; ?>">
                    <div class="uk-container uk-container-center">
                ...
                <div class="tm-top-f-box <?php echo $box_classes['top-f']; ?>">
                    <div class="uk-container uk-container-center">
                ...
                <div class="tm-top-g-box <?php echo $box_classes['top-g']; ?>">
                    <div class="uk-container uk-container-center">
            ...
            <?php endif; ?>
                ...
                <div class="tm-bottom-a-box <?php echo $box_classes['bottom-a']; ?>">
                    <div class="uk-container uk-container-center">
		...
		<?php if ($this['widgets']->count('bottom-b')) : ?>
                <div class="tm-bottom-b-box <?php echo $box_classes['bottom-b']; ?>">
                    <div class="uk-container uk-container-center">
                ...
                <div class="tm-bottom-c-box <?php echo $box_classes['bottom-c']; ?>">
                    <div class="uk-container uk-container-center">
                ...
                <div class="tm-bottom-d-box <?php echo $box_classes['bottom-d']; ?>">
                    <div class="uk-container uk-container-center">
                ...
                <div class="tm-bottom-e-box <?php echo $box_classes['bottom-e']; ?>">
                    <div class="uk-container uk-container-center">
        ...
        <div class="bottom-wrapper">
                ...
                <div class="tm-bottom-f-box <?php echo $box_classes['bottom-f']; ?>">
                    <div class="uk-container uk-container-center">
                ...
                <div class="tm-bottom-g-box <?php echo $box_classes['bottom-g']; ?>">
                    <div class="uk-container uk-container-center">
                        <section id="tm-bottom-g" class="<?php echo $grid_classes['bottom-f']; echo $display_classes['bottom-g']; ?>" data-uk-grid-match="{target:'> div > .uk-panel'}" data-uk-grid-margin>
