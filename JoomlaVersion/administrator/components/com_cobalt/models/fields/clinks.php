...
class JFormFieldClinks extends JFormField
{
	...
	public function getInput()
	{
		...
		$html[] = '<p style="clear:both" class="small"><a href="http://support.mintjoomla.com/en/cobalt-7/questions/How+to+add+aditional+Contact+or+Link+fields+to+Adress+%26+Map+field%3F-1375.html" target="_blank">'.JText::_('How to add custom links').'</a></p>';
