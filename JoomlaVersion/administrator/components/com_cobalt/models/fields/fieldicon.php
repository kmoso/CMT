...
class JFormFieldFieldicon extends JFormField
{
	...
	{
		$dir = JPATH_ROOT. DIRECTORY_SEPARATOR .'media'. DIRECTORY_SEPARATOR .'mint'. DIRECTORY_SEPARATOR .'icons'. DIRECTORY_SEPARATOR .'16';
		...
		$html .= '<img id="icon_img'.$this->fieldname.'" align="absmiddle" src="'.JURI::root().($this->value ? $path.$this->value : 'media/mint/blank.png').'"> <span id="icon_name'.$this->fieldname.'" class="icon_name">'.$this->value.'</span>';
