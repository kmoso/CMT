 ...
 * @since		1.6
 */
class CobaltModelUsers extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$groups = json_decode(CobaltFilter::base64(JFactory::getApplication()->input->get('groups', '', 'BASE64')));
		if (isset($groups)) {
			JArrayHelper::toInteger($groups);
		}
		$this->setState('filter.groups', $groups);

		$excluded = json_decode(CobaltFilter::base64(JFactory::getApplication()->input->get('excluded', '', 'BASE64')));
		if (isset($excluded)) {
