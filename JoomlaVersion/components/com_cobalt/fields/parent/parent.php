...
class JFormFieldCParent extends CFormFieldRelate
{
	public function getInput()
	{
		...
		$this->inputvalue = $this->_render_input($this->params->get('params.input_mode'), $name, $this->params->get('params.child_section'),
			JModelLegacy::getInstance('Fields', 'CobaltModel')->getFieldTypeId($this->params->get('params.child_field')));
	...
	public function onRenderFull($record, $type, $section)
	{
		return $this->_render('full', $record, $this->params->get('params.child_field'),
			JModelLegacy::getInstance('Fields', 'CobaltModel')->getFieldTypeId((int)$this->params->get('params.child_field', 0)),
