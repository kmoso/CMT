...
if (in_array($params->get('params.send_mail', 3), $this->user->getAuthorisedViewLevels()))
{
	...
	<?php case 2:?>
		<a class="btn btn-primary btn-small" onclick="getEmailIframe('<?php echo $key;?>', '<?php echo $url_form;?>');" href="#emailmodal<?php echo $record->id;?>" data-toggle="modal" role="button">
			<?php echo JText::_($this->params->get('params.popup_label', $this->label));?>
		</a>

		<div style="width:700px;" class="modal hide fade" id="emailmodal<?php echo $record->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
