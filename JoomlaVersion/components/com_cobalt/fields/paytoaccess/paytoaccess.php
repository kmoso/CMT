...
require_once JPATH_ROOT . DIRECTORY_SEPARATOR . 'components/com_cobalt/library/php/fields/cobaltcommerce.php';
...
class JFormFieldCPaytoaccess extends CFormField implements CFormFieldCommerce
{
	...
	protected function _check($record)
	{
		...
		if ($this->getErrors()) {
			...
			if ($subscr) {
				$em_api = JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_emerald' . DIRECTORY_SEPARATOR . 'api.php';
	...
	{
		$api = JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_emerald' . DIRECTORY_SEPARATOR . 'api.php';
		require_once $api;
