...
$document->addScript(JURI::root(TRUE) . '/components/com_cobalt/fields/digits/assets/jquery.ui.slider.js');
$document->addStyleSheet(JURI::root(TRUE) . '/components/com_cobalt/fields/digits/assets/css/style.css');
...
(function($){
	...
	min.on('keyup', function(){
		Cobalt.formatFloat(this, <?php echo $this->params->get('params.decimals_num', 0);?>, <?php echo $this->params->get('params.max_num', false);?>)
		var val = this.value;
