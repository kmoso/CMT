...
<select onchange="Cobalt.countFieldValues(this, <?php echo $this->id;?>, <?php echo $params->get('params.total_limit');?>, 'select')" multiple="multiple"
name="jform[fields][<?php echo $this->id;?>][]" class="elements-list cobalt-chosen-<?php echo $this->id; ?>" id="form_field_list_<?php echo $this->id;?>" <?php echo $required . $style . $size;?>>
	<?php echo implode("\n", $options);?>
</select>
