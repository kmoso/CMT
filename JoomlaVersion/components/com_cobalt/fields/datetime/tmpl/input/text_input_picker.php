...
<input type="text" value="<?php echo $default;?>" name="jform[fields][<?php echo $this->id;?>][]" id="field_<?php echo $this->id;?>"
	...
	<span class="add-on" id="date_toggle_span<?php echo $this->id;?>">
		<img id="date_toggle<?php echo $this->id;?>" src="<?php echo JURI::root(TRUE);?>/media/mint/icons/16/calendar-select.png" rel="tooltip" title="<?php echo JText::_('D_SELECTDATE');?>"
		align="absmiddle">
	</span>
</div>
...
<script type='text/javascript'>
	...
	picker<?php echo $this->id;?> = new Picker.Date($('field_<?php echo $this->id;?>'), {
		toggle: $$('date_toggle<?php echo $this->id;?>','date_toggle_span<?php echo $this->id;?>'),
		timePicker: <?php echo $this->params->get('params.time', 0);?>,
		columns: <?php echo $this->params->get('params.columns', 2);?>,
		positionOffset: {x: -150, y: 10},
		format: '<?php echo $format_js;?>'
	});
</script>
