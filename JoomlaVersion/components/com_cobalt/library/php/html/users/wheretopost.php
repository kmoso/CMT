...
<div style="width:700px;" class="modal hide fade" id="wheretopost" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body" style="overflow-x: hidden; max-height:500px; padding:0;">
    <iframe frameborder="0" width="100%" height="410px" src="<?php echo JRoute::_('index.php?option=com_cobalt&view=elements&layout=homepages&tmpl=component&section_id='.JFactory::getApplication()->input->getInt('section_id').'&record_id='.$record->id)?>"></iframe>
  </div>
