...
class CFormFieldRelate extends CFormField
{
	...
	protected function _render_autocomplete($multi, $list, $default, $limit, $name)
	{
		...
		$options['ajax_data']      = "field_id:{$this->id},func:'onGetList',field:'{$this->type}',record_id:" . ($app->input->getCmd('option') == 'com_cobalt' ? $app->input->getInt('id', 0) : 0) . ",section_id:" . $app->input->getInt('section_id');
