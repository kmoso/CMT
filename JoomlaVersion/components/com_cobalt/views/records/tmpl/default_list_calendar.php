...
<?php endif; ?>
	...
	<?php
	$url = 'index.php?option=com_cobalt&task=ajax.field_call&tmpl=component&section_id='.$this->section->id.'&field_id='.$params->get('tmpl_params.field_id_cal').'&func=getCalendarEvents';
