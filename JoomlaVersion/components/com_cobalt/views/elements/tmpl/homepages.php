...
<form action="<?php echo JFactory::getUri()->toString(); ?>" method="post" name="adminForm" id="sales-form">
	<div class="controls controls-row">
		...
		<input type="text" autocomplete="off" name="filter_search" size="16" id="filter_search" onkeyup="Cobalt.searchuserhome(this)" value=""/>
	</div>
...
(function($){
	...
	Cobalt.searchuserhome = function(el)
	{
		var needle = $(el).val();
		var haystack = '';
		var td = null;
