                ...
                <div class="jshop">
                        ...
                        <?php if (count($this->videos)) { ?>
                            <?php foreach ($this->videos as $k => $video) { ?>
                                <?php if ($video->video_code) { ?>
                                    <div class="video_full" id="hide_video_<?php print $k ?>"><?php echo $video->video_code ?></div>
                                <?php } else { ?>
                                    <a class="video_full" id="hide_video_<?php print $k ?>" href=""></a>
                                <?php } ?>
                            <?php } ?>
                        <?php } ?>
                    ...
                    <div class="jshop_img_description">
                        ...
                        <?php if (count($this->videos)) { ?>
                            <?php foreach ($this->videos as $k => $video) { ?>
                                <?php if ($video->video_code) { ?>
                                    <a href="#" id="video_<?php print $k ?>" onclick="showVideoCode(this.id);
                                            return false;"><img class="jshop_video_thumb" src="<?php print $this->video_image_preview_path . "/";
                        if ($video->video_preview) print $video->video_preview;
                        else print 'video.gif' ?>" alt="video" /></a>
                                <?php } else { ?>
                                    <a href="<?php print $this->video_product_path ?>/<?php print $video->video_name ?>" id="video_<?php print $k ?>" onclick="showVideo(this.id, '<?php print $this->config->video_product_width; ?>', '<?php print $this->config->video_product_height; ?>');
                                            return false;"><img class="jshop_video_thumb" src="<?php print $this->video_image_preview_path . "/";
                        if ($video->video_preview) print $video->video_preview;
                        else print 'video.gif' ?>" alt="video" /></a>
        <?php } ?>
        ...
        <?php print $attribut->selects ?>
                                        ...
                                        <?php if ($attribut->attr_description) { ?> 
                                            ...
                                            <script type="text/javascript">
                                                jQuery("#attributes_<?php print $attribut->attr_id ?>").nvgtooltip({
...
<?php } ?>
        ...
        <?php if ($freeattribut->required) { ?><span>*</span><?php } ?>
                                        ...
                                        <?php if ($freeattribut->description) { ?> 
                                            ...
                                            <script type="text/javascript">
                                                jQuery("#freeattribut_<?php print $freeattribut->id ?>").nvgtooltip({
...
<?php } ?>
    ...
    <?php } ?>
                    ...
                    <div class="old_price" <?php if ($this->product->product_old_price == 0) { ?>style="display:none"<?php } ?>>
                        <span class="old_price" id="old_price"><?php print formatprice($this->product->product_old_price) ?>
...
<?php } ?>
    ...
    foreach ($this->product->extra_field as $extra_field) {
        if ($extra_field['grshow']) {
            ?>
                                    <div class='block_efg'>
                                        <div class='extra_fields_group'><?php print $extra_field['groupname'] ?></div>
        <?php } ?>
                                    <div><span class="extra_fields_name"><?php print $extra_field['name']; ?></span>
                                    ...
                                    <?php if ($extra_field['description']) { ?> 
                                            ...
                                            <script type="text/javascript">
                                                jQuery("#extra_fields_tooltip_<?php print $extra_field['id'] ?>").nvgtooltip({
